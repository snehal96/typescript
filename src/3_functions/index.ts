...
export default (() => {
  ...
  function sumArray(numbers:Array<string>) {
  ...
  function getPointsFor(letter:String) {
    ...
    return lettersAndPoints.reduce((computedScore:number, pointsTuple:Array<any>) => {
  ...
  let pushToCollection: (val1:any, val2:Array<any>) => Array<any>;
